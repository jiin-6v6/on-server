    ...
    basic: function (title, login, nav, content) {
        ...
        if (results && postId) {
            ...
            <div id="content">
                <form action="/board/update_process/${postId}" method="POST">
                    ...
                    <br><br>
                    <textarea id="post_content_update" name="post_content" placeholder="내용을 입력하세요.">${results[0].post_content}</textarea>
                    <br><br>
                    <input type="file" name="post_file">
                    <br>
        ...
        <div id="content">
                    ...
                    <div class="modal-header">
                        ...
                        <form method="POST">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-primary" formaction="/my_info/update" onclick="return check_pwd();">Save changes</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <script>
                function check_pwd(){
                    ...
                    fetch('my_info/checkPwd',{
                        ...
                        .then(json => {
                            console.log(json);
                            if(json.value) window.temp_pwdCheck_value = json.value;
                            else{
                                document.querySelector("#pwdMsg").innerHTML = "정보를 확인해주세요.";
                                window.temp_pwdCheck_value = json.value;
                            }
                    });
            ...
            <form method="POST">
                ...
                <button formaction="/my_info/update" onmouseover="this.style.color='#cccccc'" onmouseout="this.style.color=''" class="btn" type="submit" id="btn_update">수정하기</button>
        ...
        <li style="position:relative;">
                ...
                <button type="submit" formaction="/my_info/update_process" class="regist_btn_a" style="position: absolute; margin-top: 30px; left:200px;" onclick="return update_check();">수정</button>
                </div>
                </ul>
                </form>
                </div>
                ...
                function check_email(){
                  ...
                  function update_check(){
                    ...
                    console.log(idReturn && birthReturn && emailReturn);
                    console.log(idReturn, birthReturn, emailReturn);
                    var returnValue = idReturn && birthReturn && emailReturn;
                    if(returnValue){
                        alert("회원정보가 수정되었습니다.");
                        return returnValue
                    } else{
